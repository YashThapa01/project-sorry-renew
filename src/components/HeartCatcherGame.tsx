...
const HelloKittyImg = '/static/images/hellokitty.gif'; // Add this import (adjust path if needed)
...
const HeartCatcherGame: React.FC<HeartCatcherGameProps> = ({ onComplete, onClose }) => {
  ...
  const kittyIntervalRef = useRef<number | null>(null);
  ...
  useEffect(() => {
    ...
    const moveItems = () => {
      ...
      animationId = requestAnimationFrame(moveItems);
    };
              ...
              <div className="space-y-4">
                ...
                <div className="bg-white p-4 rounded-lg border-2 border-dashed border-pink-300">
                  <p className="font-comic text-gray-700">
                    "Thank you for playing! I am still bad at making dynamic games.... 
