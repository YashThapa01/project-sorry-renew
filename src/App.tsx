...
// Reference public folder files directly
      ...
      >
        ...
        >
          ...
          {showLetter && (
            ...
            >
              <p className="text-gray-600 font-comic">💌 Una carta para ti...</p>
            </motion.div>
          )}
        </motion.div>
...
function App() {
  ...
  const stickyNotes = [
    { text: "Lo siento muchísimo!", style: { top: '8%', left: '4%' }, delay: 0.2 },
    { text: "Perdóneme, por favor.", style: { top: '20%', right: '6%' }, delay: 0.4 },
    { text: "Lamento mis errores.", style: { bottom: '18%', left: '5%' }, delay: 0.6 },
    { text: "Empecemos de cero.", style: { bottom: '12%', right: '8%' }, delay: 0.8 },
    { text: "Mis disculpas son sinceras.", style: { top: '50%', left: '50%', transform: 'translate(-50%, -50%)' }, delay: 1 },
  ];

  return (
    <div className="min-h-screen bg-gradient-to-b from-pink-50 to-rose-50 p-8 cursor-pointer relative overflow-hidden" onClick={addHeart}>
      {/* Floating Hearts */}
      {hearts.map((heart) => (
        <motion.div
          key={heart.id}
      ...
      <div className="max-w-4xl mx-auto space-y-16">
        <ScrollReveal animation="fade" duration={0.8}>
          <div className="text-center pt-8">
            <h1 className="text-4xl font-bold text-pink-600 mb-2 font-comic">Amorrrrrr ,</h1>
            <p className="text-gray-600 font-comic">This is a small attempt to make up for my mistake...</p>
          </div>
        </ScrollReveal>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {[{
            text: "Sé que he estado distante, y lo siento mucho...",
            img: Img1,
            caption: "Espero que puedas perdonarme."
          }, {
            text: "Lamento mis errores por descuido y el dolor que causaron.",
            img: Img2,
            caption: "Lo siento mucho y prometo mejorar."
          }].map((p, i) => (
          ...
          <div className="comic-panel bg-white p-8 rounded-lg shadow-lg relative overflow-hidden">
            ...
            <div className="bg-pink-50 p-6 rounded-lg border-2 border-dashed border-pink-300">
              <p className="text-gray-700 italic leading-relaxed font-comic text-center text-lg">
                Lamento las horas de silencio,<br />
                Por los momentos en que te fallé,<br />
                El arrepentimiento llena cada minuto que pasa.<br />
                En cada sonido perdido y solitario.<br /><br />
                Prometo reparar lo que he roto.<br />
                Para amarte en todos los sentidos,<br />
                Por favor, disculpen mis errores por descuido.<br />
                Y ayúdame a encontrar un día más brillante.
              </p>
        ...
        <ScrollReveal animation="zoom" duration={0.9} threshold={0.4}>
          ...
          >
            ...
            <p className="text-gray-700 font-comic text-center">Please forgive me.... .</p>
          </motion.div>
        </ScrollReveal>
      </div>
          ...
          >
            ...
            <div className="prose max-w-none">
              <div className="flex items-center justify-center mb-4">
                ...
                <h3 className="text-2xl font-bold text-pink-600 font-comic m-0">Dear Amor, </h3>
              </div>
              <div className="space-y-3 font-comic text-gray-700 leading-relaxed">
                <p>Lamento no haber estado ahí cuando más me necesitabas y los momentos perdidos por mi imprudencia...</p>
                <p>Lamento no haber estado ahí cuando más me necesitabas y los momentos perdidos por mi imprudencia...</p>
                <p>Por favor, perdóname por mis errores. Prometo aprender, crecer y siempre valorar nuestro vínculo.</p>
                <p className="text-right font-bold mt-4">Yours sincerely,<br />Yash</p>
              </div>
            </div>
          </motion.div>
        </div>
